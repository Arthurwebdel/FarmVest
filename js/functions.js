		...
		function showMoreActions(e) {
			...
			if (targetType === 'click') {
				if (targetEvent.closest('[data-showmore-button]')) {
					...
					const hiddenHeight = getHeight(showMoreBlock, showMoreContent);
					const moreBlockText = document.querySelector('.more-block__text')
					if (!showMoreContent.classList.contains('_slide')) {
						showMoreBlock.classList.contains('_showmore-active') ? _slideUp(showMoreContent, showMoreSpeed, hiddenHeight, moreBlockText.textContent = 'View all') : _slideDown(showMoreContent, showMoreSpeed, hiddenHeight, moreBlockText.textContent = 'Hide');
