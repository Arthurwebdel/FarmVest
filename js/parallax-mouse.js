...
import { isMobile, FLS } from "../js/functions.js";
import { flsModules } from "../js/modules.js";
	...
	paralaxMouseInit(paralaxMouse) {
		paralaxMouse.forEach(el => {
			...
			function setMouseParallaxStyle() {
				...
				el.style.cssText = `transform: translate3D(${directionX * positionX / (paramСoefficientX / 150)}%,${directionY * positionY / (paramСoefficientY / 150)}%,0) rotate(0.02deg);`;
